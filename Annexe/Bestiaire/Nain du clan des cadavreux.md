...
traits:
  ...
  - name: Attaques multiples
    desc: Le Cadavreux effectue deux attaques au corps-à-corps.
actions:
  - name: Arbalète lourde
    desc: "Attaque d’arme à distance : +2 pour toucher, portée 30/120 m, une cible. Touché : 5 (1d10) dégâts perforants."
  - name: Hache d'arme
...
treasure:
  ...
  - name: Arbalète lourde
  - name: Hache d'arme
  - name: "Lancer 1d6 : [1-2] feu grégeois, [3-4] chausse-trappes ou [5-6] petit fumigène"
  - name: "Lancer 1d10 po"
```
