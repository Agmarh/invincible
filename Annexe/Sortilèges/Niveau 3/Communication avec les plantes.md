...
distance: personnelle (9 mètres de rayon)
composantes: V, S
temps: 10 minutes
...
Ce sort permet de libérer une créature [_entravée_](https://5e-drs.fr/gerer-la-sante-du-personnage/#entrave) par les plantes nées d'un sort d'_enchevêtrement_.