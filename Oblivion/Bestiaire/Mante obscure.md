...
actions:
  ...
  - name: Etouffer
    desc: "Attaque d'arme au corps à corps : +5 pour toucher, allonge 1,50 m, une créature.  
Touché : 6 (1d6+3) dégâts contondants et la mante obscure se fixe sur la cible. Si la cible est de taille M ou plus petite et que la mante obscure obtient un avantage lors du jet d'attaque, elle se fixe en enveloppant la tête de la cible et celle-ci est également [[Aveuglé]] et incapable de respirer tant que la mante obscure reste fixée de la sorte.  
