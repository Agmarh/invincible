...
actions:
  ...
  - name: Dard caudal
    desc: "Attaque d'arme au corps à corps : +7 pour toucher, allonge 3 m, une créature. Touché : 11 (2d6+4) dégâts perforants. La cible doit effectuer un jet de sauvegarde de Constitution DD 15 ; elle subit 24 (7d6) dégâts de poison en cas de jet de sauvegarde raté ou la moitié de ces dégâts seulement en cas de réussite."
  - name: Griffes
    desc: "Attaque d'arme au corps à corps : +7 pour toucher, allonge 1,50 m, une cible. Touché : 13 (2d8+4) dégâts tranchants."
  - name: Morsure
    desc: "Attaque d'arme au corps à corps : +7 pour toucher, allonge 3 m, une créature. Touché : 11 (2d6+4) dégâts perforants."
```
