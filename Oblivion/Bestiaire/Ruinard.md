...
actions:
  - name: Attaques multiples
    desc: "Le ruinard effectue deux attaques : une avec sa morsure et une avec ses mandibules. Si les deux attaques réussissent sur une même créature, il peut tenter de l’engloutir."
  - name: Morsure
    desc: "Attaque d’arme au corps-à-corps : +5 pour toucher, allonge 1,50 m, une cible. Touché : 13 (3d6+3) dégâts perforants."
  - name: Mandibule
