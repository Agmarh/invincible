...
actions:
  - name: Attaques multiples
    desc: "Un amphibe sans arme effectue 3 attaques : 1 en mordant et 2 avec sa lance."
  - name: Morsure
    desc: "Attaque d’arme au corps à corps : +6 pour toucher, allonge 1,50 m, une cible. Touché : 7 (1d8+3) dégâts perforants."
  - name: Lance
    desc: "Attaque d’arme de jet ou au corps à corps. +6 pour toucher, allonge 1,50 m ou portée 6 m/18 m, une cible. Touché : 6 (1d6+3) dégâts perforants ou 7 (1d8+3) dégâts perforants si elle est utilisée à deux mains au corps à corps."
  - name: Filet
    desc: "Attaque d’arme de jet. +6 pour toucher, portée 1,5 m/4,5 m, une cible d’une catégorie de taille Grande ou inférieure. Touché : la cible est entravée. Elle peut effectuée son action pour faire un test de Force (DD 10) pour tenter de se libérer ou pour libérer une autre créature à portée. Une réussite du test met fin à l’effet du filet. En infligeant 5 points de dégâts tranchants au filet (CA 10), il est possible de libérer les victimes sans les blesser, mais cela détruit le filet."
```
