...
actions:
  - name: Javeline
    desc: "Attaque d'arme au corps à corps ou à distance : +4 pour toucher, allonge 1,50 m ou portée 9/36 m, une cible. Touché : 9 (2d6+2) dégâts perforants au corps à corps ou 5 (1d6+2) dégâts perforants à distance."
  - name: Morgenstern
    desc: "Attaque d'arme au corps à corps : +4 pour toucher, allonge 1,50 m, une cible. Touché : 11 (2d8+2) dégâts perforants."
```
