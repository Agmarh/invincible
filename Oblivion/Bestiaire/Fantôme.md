...
actions:
  ...
  - name: Visage terrifiant
    desc: "Toutes les créatures, à l'exception des morts-vivants, situées à 18 mètres ou moins du fantôme et qui le voient doivent chacune réussir un jet de sauvegarde de Sagesse DD 13 pour ne pas être [[Terrorisé]] pendant 1 minute. Si le jet de sauvegarde rate de 5 points ou plus, la cible vieillit également de 1d4×10 ans. Une cible [[Terrorisé]] peut retenter le jet de sauvegarde à la fin de chacun de ses tours et mettre fin à l'effet dont elle est victime en cas de réussite. Si le jet de sauvegarde d'une cible est réussi ou si l'effet prend fin, la cible est immunisée aux effets du visage terrifiant de ce fantôme pendant 24 heures. Il est possible d'inverser l'effet de vieillissement grâce à un sort de [[Restauration inférieure]] s'il est lancé dans les 24 heures suivantes."
```
