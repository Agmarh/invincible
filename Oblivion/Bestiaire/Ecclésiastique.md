...
cr: 2
spells:
  - "Incantation. L'ecclésiastique est un lanceur de sorts de niveau 5. Sa caractéristique d'incantation est la Sagesse (DD du jet de sauvegarde contre les sorts 13, +5 pour toucher avec les attaques de sort). Voici ses sorts de clerc préparés."
...
actions:
  - name: Masse d'armes
    desc: "_Attaque d'arme au corps à corps_ : +2 pour toucher, allonge 1,50 m, une cible. Touché : 3 (1d6) dégâts contondants."
```
